 ...
 */
class Cradle_Terminal_TerminalException_Test extends TestCase
{
  /**
  ...
  /**
   * @covers Cradle\Terminal\TerminalException::forArgumentCount
   */
  ...
  /**
   * @covers Cradle\Terminal\TerminalException::forResponseNotFound
   */
