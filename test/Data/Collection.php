 ...
 */
class Cradle_Data_Collection_Test extends TestCase
{
  /**
   * @var Collection
   */
  ...
  /**
   * @covers Cradle\Data\Collection::getEventEmitter
   */
  ...
  /**
   * @covers Cradle\Data\Collection::setEventEmitter
   */
  public function testSetEventEmitter()
  {
    $instance = $this->object->setEventEmitter(new \Cradle\Event\EventEmitter);
    $this->assertInstanceOf('Cradle\Data\Collection', $instance);
  }
