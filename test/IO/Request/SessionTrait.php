 ...
 */
class Cradle_IO_Request_SessionTrait_Test extends TestCase
{
  /**
   * @var SessionTrait
   */
  ...
  /**
   * covers Cradle\IO\Request\SessionTrait::getSession
   */
  ...
  /**
   * covers Cradle\IO\Request\SessionTrait::hasSession
   */
  ...
  /**
   * covers Cradle\IO\Request\SessionTrait::removeSession
   */
  ...
  /**
   * covers Cradle\IO\Request\SessionTrait::setSession
   */
  public function testSetSession()
  {
    ...
    $this->assertInstanceOf('Cradle\IO\Request\SessionTraitStub', $instance);
...
if(!class_exists('Cradle\IO\Request\SessionTraitStub')) {
