 ...
 */
class Cradle_IO_Response_RestTrait_Test extends TestCase
{
  /**
   * @var RestTrait
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::addValidation
   */
  public function testAddValidation()
  {
    $instance = $this->object->addValidation('zoo', 'foo');
    $this->assertInstanceOf('Cradle\IO\Response\RestTraitStub', $instance);
  }

  /**
   * covers Cradle\IO\Response\RestTrait::getResults
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::getMessage
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::getMessageType
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::getValidation
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::hasJson
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::hasMessage
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::hasResults
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::hasValidation
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::isError
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::isSuccess
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::removeResults
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::removeValidation
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::setError
   */
  ...
  /**
   * covers Cradle\IO\Response\RestTrait::setResults
   */
...
if(!class_exists('Cradle\IO\Response\RestTraitStub')) {
