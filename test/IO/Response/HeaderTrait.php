 ...
 */
class Cradle_IO_Response_HeaderTrait_Test extends TestCase
{
  /**
   * @var HeaderTrait
   */
  ...
  /**
   * covers Cradle\IO\Response\HeaderTrait::addHeader
   */
  public function testAddHeader()
  {
    $instance = $this->object->addHeader('zoo', 'foo');
    $this->assertInstanceOf('Cradle\IO\Response\HeaderTraitStub', $instance);
  ...
  /**
   * covers Cradle\IO\Response\HeaderTrait::getHeaders
   */
  ...
  /**
   * covers Cradle\IO\Response\HeaderTrait::removeHeader
   */
...
if(!class_exists('Cradle\IO\Response\HeaderTraitStub')) {
